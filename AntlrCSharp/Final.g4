...
condition			: (literals | ID) arithmetic CON (literals | ID) arithmetic;//defines a conditional statement between literals and variables
conState			: condition (CONDITIONAL condition)* END oneLine; // defines the beginning of each statement type
